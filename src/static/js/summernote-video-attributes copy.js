  ...
  $.extend($.summernote.plugins,{
    'videoAttributes':function(context){
      ...
      this.initialize=function(){
        ...
        var body='<div class="form-group">'+
          ...
          '<div class="form-group">'+
            ...
            '</div>'+
          '</div>'+
          // Added start and end time inputs
      ...
      this.validateInput = function() {
        ...
        //If the input seconds or minutes is greater than 59, it resets the value to 0
        if (startMin > 59) {
          startMin = 0;
          $videoStartMin.val(0);
        }
        ...
        //enables the OK button if the URL is valid and the start time is less than the end time
